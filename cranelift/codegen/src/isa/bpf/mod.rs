...
use crate::isa::bpf::inst::regs::create_reg_universe;
...
impl BPFBackend {
    ...
    pub fn new_with_flags(triple: Triple, flags: shared_settings::Flags) -> BPFBackend {
    ...
    fn compile_vcode(
        ...
        compile::compile::<BPFBackend>(func, self, abi, emit_info)
    }
}

impl MachBackend for BPFBackend {
    fn compile_function(
        &self,
        func: &Function,
        want_disasm: bool,
...
pub fn isa_builder(triple: Triple) -> IsaBuilder {
    assert!(triple.architecture == Architecture::Bpfel);
    IsaBuilder {
        triple,
        setup: settings::builder(),
        constructor: |triple, shared_flags, _| {
            let backend = BPFBackend::new_with_flags(triple, shared_flags);
...
mod test {
    ...
    fn test_compile_function() {
        ...
        let backend = BPFBackend::new_with_flags(Triple::from_str("bpf").unwrap(), shared_flags);
